...
class MultiActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textScore=findViewById(R.id.textViewMultiScore)
        textLife=findViewById(R.id.textViewMultiLife)
        textTime=findViewById(R.id.textViewMultiTime)
        textQuestion=findViewById(R.id.textViewMultiQuestion)
        editTextAnswer=findViewById(R.id.editTextMultiAnswer)
        buttonOk=findViewById(R.id.buttonMultiOk)
        buttonNext=findViewById(R.id.buttonMultiNext)
