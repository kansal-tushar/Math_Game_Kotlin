...
class SubtractionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textScore=findViewById(R.id.textViewSubScore)
        textLife=findViewById(R.id.textViewSubLife)
        textTime=findViewById(R.id.textViewSubTime)
        textQuestion=findViewById(R.id.textViewSubQuestion)
        editTextAnswer=findViewById(R.id.editTextSubAnswer)
        buttonOk=findViewById(R.id.buttonSubOk)
        buttonNext=findViewById(R.id.buttonSubNext)
